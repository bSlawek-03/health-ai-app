...
const initialNotifications = [
  { id: 1, icon: "ai", title: "AI Analysis Ready", desc: "Your latest heart rate analysis is done.", time: "2 min ago", read: false },
  { id: 2, icon: "water", title: "Drink Water", desc: "You haven't logged water intake today.", time: "1 hr ago", read: false },
  { id: 3, icon: "heart", title: "Heart Rate OK", desc: "Your resting heart rate is within normal range.", time: "3 hr ago", read: true },
  { id: 4, icon: "run", title: "Daily Goal Reached", desc: "You hit 10,000 steps today.", time: "5 hr ago", read: true },
]
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="relative w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition"
      >
        ...
        <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 z-50">
          ...
          <div className="max-h-80 overflow-y-auto divide-y divide-gray-50 dark:divide-gray-700">
            {notifications.map((n) => (
              ...
              >
                <span className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-gray-700 text-blue-500 dark:text-blue-400 flex items-center justify-center shrink-0">
